...
class ConfigureScalar(Group, metaclass=InstrumentMetaclass):
    ...
    class temperature(GenericCommandClass):
        """Configure for osrom temperature measurement"""
    ...
    class resistance(GenericCommandClass):
        """Configure for osrom presence resistance measurement"""
...
class MeasureScalar(Group, metaclass=InstrumentMetaclass):
    ...
    class temperature(GenericCommandClass):
        """Performs a osrom temperature measurement"""
    ...
    class resistance(GenericCommandClass):
        """Performs a osrom presence resistance measurement"""
...
class SystemSensor(Group, metaclass=InstrumentMetaclass):
    class idn(GenericGetCommandClass):
        """Query information about the connected osrom.
        This is a query only command.
        The response consists of the following fields:
        """
        cmd = 'System:Sensor:IDN'
        full_acces = 'system.osrom.idn'
...
class InputAdapter(Group, metaclass=InstrumentMetaclass):
    class type(GenericSetCommandClass):
        """Sets default osrom adapter type"""
