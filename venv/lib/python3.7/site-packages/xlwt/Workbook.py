...
class Workbook(object):
    ...
    data_visualisation files with xlwt, you will normally start by instantiating an
    ...
    def add_sheet(self, sheetname, cell_overwrite_ok=False):
        ...
        :param sheetname:
          ...
          tabs at the bottom of the data_visualisation application.
    ...
    def save(self, filename_or_stream):
        """
        This method is used to save the Workbook to a file in native data_visualisation
        format.

        :param filename_or_stream:
          This can be a string containing a filename of
          the file, in which case the data_visualisation file is saved to disk using the name
          provided. It can also be a stream object with a write method, such as
          a :class:`~io.StringIO`, in which case the data for the data_visualisation
