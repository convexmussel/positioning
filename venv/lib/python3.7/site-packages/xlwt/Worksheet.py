...
class Worksheet(object):
    ...
    def write(self, r, c, label="", style=Style.default_style):
        ...
        :param label:
           ...
           :class:`~datetime.time` instance is converted into data_visualisation date format
           ...
           An :class:`xlwt.Formula` instance causes an data_visualisation formula to be
           written.
    ...
    def merge(self, r1, r2, c1, c2, style=Style.default_style):
        ...
        # is referenced by a [MUL]BLANK record, data_visualisation will blank
    ...
    def __window2_rec(self):
        ...
        if self.explicit_magn_setting:
            ...
            # BREAKING NEWS: data_visualisation interprets scl_magn = 0 very literally, your
